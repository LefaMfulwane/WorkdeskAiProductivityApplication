...
export default function ProfessionalCVBuilder() {
  return (
    <div className="p-6">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">AI-powered resume and cover letter creation</p>
        </div>
      </div>
      <Card>
        <CardHeader>
          <CardTitle>Coming Soon</CardTitle>
          <CardDescription>Professional CV and cover letter builder with AI assistance</CardDescription>
        </CardHeader>
        <CardContent>
